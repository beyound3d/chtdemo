...
public class ShareStatusWith extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_share_status_with);
        ButterKnife.bind(this);
        setSupportActionBar(toolbar);
        tvTitle.setText(R.string.share_status_with);
